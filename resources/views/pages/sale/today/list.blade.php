      ...
      <div class="col-md-12">
         <div class="row">
            ...
            <div class="col-md-6 text-right">
                  <a href="{{route('today-sale-add')}}" class="btn btn-info">Add Sale</a>
            </div>
         </div>
      </div>
      <div class="col-md-12">
               ...
               <tbody>
                ...
                @endphp
                    <tr>
                        ...
                        <td>{!! $status !!}</td>
                        <td>{!! '<a href="'.(url("today-sale/edit/".$sale->id)).'" class="btn btn-info"><i class="fa fa-pencil" aria-hidden="true"></i></a>
