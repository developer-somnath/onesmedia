      ...
      <div class="col-md-12">
         <div class="row">
            ...
            <div class="col-md-6 text-right">
                  <a href="{{route('sample-file-add')}}" class="btn btn-info">Add Sample File</a>
            </div>
         </div>
      </div>
      <div class="col-md-12">
         <div class="main-card mb-3 card p-3">
            ...
            <table class="table table-bordered" id="sampleFileTable" width="100%" >
               <thead>
                  <tr>
                     <th>SL. No.</th>
                     <th>Title</th>
...
<script>
   ...
   const loadData=()=>{
      $('#sampleFileTable').DataTable().destroy();
      var dataTable = $('#sampleFileTable').DataTable({
            dom: 'Bfrtip',
            processing: true,
            serverSide: true,
            searching:  false,
            ajax: {
              url: "{{route('ajax-sample-file-list')}}",
              type:'get',
              data: function(data){
