   ...
   <div class="row">
      <div class="col-md-12">
         <div class="row">
            ...
            <div class="col-md-6 text-right"><a href="{{route('sample-file-list')}}" class="btn btn-info">Sample File List</a></div>
         </div>
      </div>
      <div class="col-md-12">
         <div class="main-card  p-3 card">
            ...
            <form class="adminFrm" data-action="sample-file/list" method="post">
               @csrf
               ...
               <div class="form-row">
                  ...
                  <div class="col-md-6">
                     <div class="position-relative form-group">
                        ...
                        <img src="{{ asset('uploads/sample-files/'.$oldData->image) }}" width="180" height="150">
                        @endif
                     </div>
                  </div> 
                  <div class="col-md-12">
                  ...
                  <div class="col-md-6">
                     <div class="position-relative form-group">
                        ...
                        @if(!is_null($oldData))
                           <audio controls >
                              <source src="{{ asset('uploads/sample-files/'.$oldData->file_name) }}" type="audio/ogg">
                              <source src="{{ asset('uploads/sample-files/'.$oldData->file_name) }}" type="audio/mpeg">
